  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] text-slate-950">
      <div className="mx-auto flex min-h-screen w-full max-w-3xl items-center px-5 py-16 sm:px-8">
        <section className="w-full rounded-[32px] bg-white p-8 text-center shadow-[0_1px_2px_rgba(15,23,42,0.04),0_20px_48px_rgba(15,23,42,0.08)] ring-1 ring-slate-900/6 sm:p-12">
