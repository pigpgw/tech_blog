INSERT INTO categories (name, slug, path, sort_order)
VALUES
    ('미분류', 'uncategorized', 'uncategorized', 999),
    ('AI', 'ai', 'ai', 1);

INSERT INTO categories (name, slug, path, parent_id, sort_order)
SELECT
    'Prompt Engineering',
    'prompt-engineering',
...
$blog_post$,
    'PUBLISHED',
    TIMESTAMPTZ '2026-05-22 00:00:00+09:00',
    TIMESTAMPTZ '2026-05-22 00:00:00+09:00',
    TIMESTAMPTZ '2026-05-22 00:00:00+09:00'
FROM categories
WHERE path = 'ai/prompt-engineering';
